...
<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class=""><b>
            <span style="color:#ebce17;"></span><br>
            <input type="hidden" value="1" name="student_program_choice"><span style="color:#ebce17;"> {{-- One program (Bachelor or Master) --}}</span><br>
