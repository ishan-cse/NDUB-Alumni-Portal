...
<div class="no-page-break">
                ...
                <img id="img1" style="float:right;" src="data:image/png;base64,<?=  base64_encode(file_get_contents(public_path('uploads/student/'.$student_photo))) ?>" alt="">
                    <div style="">
                        <p style="text-align: center;">
                            ...
                            <span style="font-size: 12px;">Phone: +880 2-41070719, 01725692919<</span><br>
    ...
    <div class="row">
        <div class="col-12 mt-2">
            <div class="table-responsive">
            <p style="font-size: 14px; font-weight: bold">Registered Program Details (Double Program)</p>
                <table class="table table-bordered">
                    <tr>
                        <td colspan="1">
                            <span class="text-left" style="font-size: 11px; font-weight: bold">
                    ...
                    <tr>
                        <td colspan="4">
                            <span class="text-left" style="font-size: 11px; font-weight: bold">
                            Academic Year: {{$admission_semester ? $admission_semester : ''}} {{$admission_year ? $admission_year : ''}} - {{$passing_trimester ? $passing_trimester : ''}} {{$passing_year ? $passing_year : ''}}
                            </span>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td colspan="4">
                            <span class="text-left" style="font-size: 11px; font-weight: bold">
                            Academic Year: {{$admission_semester1 ? $admission_semester1 : ''}} {{$admission_year1 ? $admission_year1 : ''}} - {{$passing_trimester1 ? $passing_trimester1 : ''}} {{$passing_year1 ? $passing_year1 : ''}}
                            </span>
                        </td>
                    </tr>
                    <tr>
    ...
    <div class="row">
        <div class="col-12 mt-2">
            <div class="table-responsive">
                ...
                <b>Maximum two (2) persons are allowed. Once submitted, guest names will not be changed. Guests less than 15 years old are not allowed to be accompanied in the convocation ceremony. Depends on the availability of seats. First come first get basis.</b>
                </p>
                    <table class="table table-bordered">
                        <tr>
                            <td colspan="1">
                        ...
                        <tr>
                            ...
                            <td colspan="1">
                                @if($guest1_photo!='')
                                    <img id="img3" style="" src="data:image/png;base64,<?=  base64_encode(file_get_contents(public_path('uploads/guest/'.$guest1_photo))) ?>" alt="">
                                @else
                                @endif
                            </td>
                            <td colspan="1">
                                @if($guest2_photo!='')
                                    <img id="img3" style="" src="data:image/png;base64,<?=  base64_encode(file_get_contents(public_path('uploads/guest/'.$guest2_photo))) ?>" alt="">
                                @else
                                @endif
                            </td>
                        </tr>
    ...
    <div class="row">
            ...
            <p style="font-size: 12px; font-weight: bold">Money Receipt No./Ref. No.: ____________________________________  Payment Date: ___________________________
            </p>
            ...
            <table class="table table-bordered">
                <b style="font-size: 11px; font-weight: bold">For office use only</b>
                <tr>
                    <td colspan="1">
                        <span class="text-left" style="font-size: 11px; font-weight: bold">
                        Library (Room# 601)
                ...
                <tr>
                    <td colspan="1">
                        <span class="text-center" style="font-size: 11px; font-weight: normal">
                        <br><br><br><br>
                        </span>
                    </td>
                    <td colspan="1">
    ...
    Please bring the following required documents along with the Online Registration Form:
    <ol style="font-size: 11px; font-weight: normal">
    <li>NDUB Provisional Certificate (If taken), attested copies of Certificates and Transcripts of SSC & HSC.</li>
    <li>Four copies of passport-size color photographs in formal dress with <b>white background</b>. Write your name and ID on the backside of the photographs.</li>
    <li>Registration fee, <b>TK. 8,000.00/- (for one degree)</b>, <b>TK. 10,000.00/- (for two degrees)</b> payable through any branch of Mercantile Bank Limited or by Rocket and Nexus Pay.</li>
    <li>‘Payment Slip’ of Registration Fee, Student ID and the Library Cards, photocopy of NID along with the Registration Form must be submitted to the Registration Booth during the office hours.</li>
    <li>A passport-size photo for each guest and, a photocopy of their NID Card/Birth Registration Certificate.</li>
