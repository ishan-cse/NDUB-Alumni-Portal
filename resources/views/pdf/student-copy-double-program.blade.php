...
<!-- <button onclick="window.print()">Print</button> -->
        ...
        <div class="row mt-2">
            <div class="image-container">
                ...
                <p style="text-align: center;">
                    ...
                    <span style="font-size: 16px;">2nd CONVOCATION STUDENT COPY</span><br>
    ...
    <li>Rehearsal is compulsory for the Convocation.</li>
    <li>The ‘Student Copy’ must be retained by the graduate for further necessity until receiving the Official Certificate.</li>
    <li>For physically challenged guests, students must inform the NDUB authority in advance.</li>
    <li>To receive the Official Certificate the graduate must be present in person.</li>
    <li>Contact Number: 01725692919<</li>
    <li>Email: convocation.support@ndub.edu.bd</li>
