...
@if($user->student_program_choice==3)
        <div class="row">
            ...
            <h3 class="text-center">
                @if($user->second_program_grad_list_id==0)
                    ...
                    @endif
                @elseif($user->second_program_grad_list_id!=0)
                    @if($user->bachelor_program_status==1)
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped table-hover dt-responsive view_table">
                        ...
                        <td>
                        @if($user->second_program_grad_list_id!=0)
                            @if($user->secondProgramInfo->program_id!=0)
                        ...
                        <td>
                        @if($user->second_program_grad_list_id!=0)
                            @if($user->secondProgramInfo->batch_id!=0)
