...
class ConvocationRegistrationController extends Controller{
    ...
    public function update(Request $request): RedirectResponse{
        $this->validate($request,[
            ...
            'employer_email'=>'max:50',
            'higher_studies'=>'max:100',
            'self_emp'=>'max:100',
            'other'=>'max:100',
        ],[
        ...
        $update = GraduateList::where('id', $request->id)->update([
            ...
            'higher_studies'=>$request->higher_studies,
            'self_emp'=>$request->self_emp,
            'other'=>$request->other,
            'edit_start_status'=>1,
    ...
    public function paymentSlipPDF(){
        $filePath = public_path('documents/collection-slip.pdf'); // Adjust the file path accordingly
        // if(file_exists($filePath)) {
        return response()->download($filePath, 'collection-slip.pdf', ['Content-Type' => 'application/pdf']);
    }
}